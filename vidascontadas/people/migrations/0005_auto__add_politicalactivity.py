...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PoliticalActivity'
        db.create_table(u'people_politicalactivity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('people', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.People'])),
            ('affiliation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['politician.Affiliation'])),
        ))
        db.send_create_signal(u'people', ['PoliticalActivity'])


    def backwards(self, orm):
        # Deleting model 'PoliticalActivity'
        db.delete_table(u'people_politicalactivity')
