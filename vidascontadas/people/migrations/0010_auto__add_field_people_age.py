...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'People.age'
        db.add_column(u'people_people', 'age',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'People.age'
        db.delete_column(u'people_people', 'age')
    ...
    models = {
        ...
        u'people.people': {
            ...
            'genre': ('django.db.models.fields.CharField', [], {'default': "'U'", 'max_length': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
