...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'People.burying_place'
        db.alter_column(u'people_people', 'burying_place_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['places.Place']))

        # Changing field 'People.url'
        db.alter_column(u'people_people', 'url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200))

        # Changing field 'People.place_birth'
        db.alter_column(u'people_people', 'place_birth_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['places.Place']))

        # Changing field 'People.address'
        db.alter_column(u'people_people', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['places.Place']))

        # Changing field 'People.place_death'
        db.alter_column(u'people_people', 'place_death_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['places.Place']))

    def backwards(self, orm):

        # Changing field 'People.burying_place'
        db.alter_column(u'people_people', 'burying_place_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['places.Place']))

        # Changing field 'People.url'
        db.alter_column(u'people_people', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'People.place_birth'
        db.alter_column(u'people_people', 'place_birth_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['places.Place']))

        # User chose to not deal with backwards NULL issues for 'People.address'
        raise RuntimeError("Cannot reverse this migration. 'People.address' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'People.address'
        db.alter_column(u'people_people', 'address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['places.Place']))

        # Changing field 'People.place_death'
        db.alter_column(u'people_people', 'place_death_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['places.Place']))
    ...
    models = {
        ...
        u'people.people': {
            ...
            'date_birth': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dates_birth'", 'to': u"orm['common.CustomDate']"}),
            'date_death': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dates_death'", 'to': u"orm['common.CustomDate']"}),
