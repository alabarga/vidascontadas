...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'People.date_birth' to match new field type.
        db.rename_column(u'people_people', 'date_birth', 'date_birth_id')
        # Changing field 'People.date_birth'
        db.alter_column(u'people_people', 'date_birth_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.CustomDate']))
        # Adding index on 'People', fields ['date_birth']
        db.create_index(u'people_people', ['date_birth_id'])


        # Renaming column for 'People.date_death' to match new field type.
        db.rename_column(u'people_people', 'date_death', 'date_death_id')
        # Changing field 'People.date_death'
        db.alter_column(u'people_people', 'date_death_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.CustomDate']))
        # Adding index on 'People', fields ['date_death']
        db.create_index(u'people_people', ['date_death_id'])


    def backwards(self, orm):
        # Removing index on 'People', fields ['date_death']
        db.delete_index(u'people_people', ['date_death_id'])

        # Removing index on 'People', fields ['date_birth']
        db.delete_index(u'people_people', ['date_birth_id'])


        # Renaming column for 'People.date_birth' to match new field type.
        db.rename_column(u'people_people', 'date_birth_id', 'date_birth')
        # Changing field 'People.date_birth'
        db.alter_column(u'people_people', 'date_birth', self.gf('django.db.models.fields.DateTimeField')())

        # Renaming column for 'People.date_death' to match new field type.
        db.rename_column(u'people_people', 'date_death_id', 'date_death')
        # Changing field 'People.date_death'
        db.alter_column(u'people_people', 'date_death', self.gf('django.db.models.fields.DateTimeField')())
