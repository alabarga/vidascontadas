...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EventPeople'
        db.create_table(u'people_eventpeople', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('role', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('people', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_people_people', to=orm['people.People'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_people_event', to=orm['events.Event'])),
        ))
        db.send_create_signal(u'people', ['EventPeople'])


    def backwards(self, orm):
        # Deleting model 'EventPeople'
        db.delete_table(u'people_eventpeople')
    ...
    models = {
        ...
        u'people.eventpeople': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_people_event'", 'to': u"orm['events.Event']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'people': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_people_people'", 'to': u"orm['people.People']"}),
