...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'places_place', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cities_light.City'], null=True))

    def backwards(self, orm):

        # Changing field 'Place.city'
        db.alter_column(u'places_place', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['cities_light.City']))
