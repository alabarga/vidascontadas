...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field medias on 'Place'
        m2m_table_name = db.shorten_name(u'places_place_medias')
        ...
        db.create_unique(m2m_table_name, ['place_id', 'media_id'])


    def backwards(self, orm):
        # Removing M2M table for field medias on 'Place'
        db.delete_table(db.shorten_name(u'places_place_medias'))
